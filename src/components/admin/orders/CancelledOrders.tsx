  ...
  return (
    <div className="space-y-6">
      ...
      <input
        ...
        className="w-full rounded-lg border border-zinc-200 dark:border-zinc-700 px-4 py-2 text-sm bg-white dark:bg-zinc-900 focus:ring-2 focus:ring-blue-500 outline-none"
      />
        ...
        {filteredOrders.length === 0 ? (
          ...
          filteredOrders.map((order) => (
            <div
              ...
              className={`bg-white dark:bg-zinc-900 rounded-xl shadow-sm border overflow-hidden flex flex-col cursor-pointer hover:shadow-md hover:border-red-300 transition-all ${
                order.status === "INACTIVE"
                  ? "border-zinc-200 dark:border-zinc-800 opacity-75"
                  : "border-zinc-200 dark:border-zinc-800"
              }`}
            >
              <div className="p-4 bg-zinc-50 dark:bg-zinc-800 border-b border-zinc-200 dark:border-zinc-700 flex justify-between items-start">
                <div>
              ...
              <div className="p-4 grow space-y-3">
                  ...
                  {order.OrderItems.map((item) => (
                    ...
                    >
                      <div className="flex gap-2">
                        <span className="font-bold w-6 text-center bg-zinc-100 dark:bg-zinc-700 rounded text-zinc-700 dark:text-white">
                          {item.quantity}x
                        </span>
                ...
                {order.notes && (
                  <div className="mt-4 p-2 bg-green-50 text-zinc-900 text-xs rounded border border-green-100">
              ...
              <div className="p-4 border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800">
                <div className="flex justify-between items-center mb-4">
                  <span className="text-sm text-zinc-900 dark:text-white">Total</span>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {order.status === "INACTIVE" && (
                    <button
                      ...
                      className="bg-green-900 hover:bg-green-700 text-white py-2 rounded-md text-sm font-medium transition disabled:opacity-50"
                  >
                      Reopen
                    </button>
                  )}
