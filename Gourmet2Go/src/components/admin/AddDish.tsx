...
const dishSchema = z.object({
  ...
  category: z.enum(['Other', 'Soups', 'Salads', 'Sandwiches', 'Entrees', 'Desserts', 'Bowl']),
});
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-12 bg-white dark:bg-zinc-900 transition-colors">
      <div className="w-full max-w-lg bg-white dark:bg-zinc-800 shadow-xl rounded-2xl border border-zinc-200 dark:border-zinc-700 p-8 space-y-6">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-center bg-gradient-to-r from-blue-600 to-green-500 bg-clip-text text-transparent">
          Add New Dish
        </h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <button 
            ...
            className="w-full rounded-lg bg-gradient-to-r from-blue-600 to-green-500 px-4 py-2 text-white font-semibold shadow-lg hover:scale-[1.02] transition-transform disabled:opacity-50 disabled:cursor-not-allowed"
          >
